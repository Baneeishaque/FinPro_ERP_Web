<!-- BREAD CRUMB OWNER income tax create  -->
<ul id="breadcrumbs-owner" >
        <li><a  href="<?php echo base_url('owner/budget')?>">BUDGET AND ACCOUNT</a></li> 
        <li><a  href="<?php echo base_url('owner/incometax')?>">INCOME TAX</a></li> 
        <li><a>CREATE</a></li>
                ...
                <div class=" col-md-6 col-sm-12">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="ledgerinput" name="assigned">
                ...
                <div class="col-md-6 col-sm-12">
                                ...
                                <div class="row">
                                    <div class="form-group ">
                                            ...
                                            <label class="formlabels" for="tax">TAX</label>
                                            <input type="text" name="tax" class="ledgerinput">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                 ...
                                 <div class="row">
                                        <div class="form-group">
                                            <label class="formlabels" for="it_username">IT USERNAME</label>
                                            <input type="text" name="it_username" class="ledgerinput">
                                   ...
                                   <div class="row">
                                    <div class="form-group">
                                        <label class="formlabels" for="pw">PW</label>
